...
MODULE_STUB = 'enigma_alglin'

setup(
    name=MODULE_STUB,  # Substitua pelo nome do seu pacote
    version="0.1.0",
    author="Felipe Mariano",
    author_email="felipemf2@al.insper.edu.br",
    description="Um pacote minimalista em python",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/felipemarianoferr/enigma_alglin.git",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'enigma_alglin={MODULE_STUB}.main:main',
        ],
    },
